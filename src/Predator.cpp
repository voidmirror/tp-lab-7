...
Predator::Predator(int x, int y, Ocean* ocean) : LivingObject(x, y, ocean) { symbol = PREDATOR; }

Predator::Predator(coord coordinates, Ocean* ocean) : LivingObject(coordinates, ocean) { symbol = PREDATOR; }
...
std::string Predator::getName() { return "Predator"; }
